...
export default class SQL {
  ...
  static getRandomFieldName() {
    if (Helpers.getRandomInt(1, 10) <= 3) {
      return Helpers.getRandomEntry(fieldNames) + " AS " + Helpers.getRandomEntry(fieldNames);
    } else {
  ...
  static getRandomWhereCondition() {
    let where = Helpers.getRandomEntry(fieldNames) + " = " + Helpers.getRandomInt(1, 100000);
    return where;
  }
